...
public class ScreenShot {
    public static void shoot(Activity activity) {
        String folderPath = FileUtils.saveFile(activity.getApplication(),"sdcard");
    ...
    private static Bitmap takeScreenShot(Activity activity) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(bitmap1, 0, statusBarHeight, width, height);
